...
Data: 2026-06-26T09:38:24.331447+00:00
Modo: preview

## Evidência
- Menus: `main-menu, mega-menu-c-pia-1, mega-menu-mobile`
- Coleções alvo: `144`
- Produtos escaneados: `2365`
- Produtos com mudança planejada: `0`
- NEW 90d encontrados: `203`
...
## Rollback
- Snapshot: `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/reports/catalog-badges-sync/badge-sync-20260626T093824Z/rollback-snapshot.json`
