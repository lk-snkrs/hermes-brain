...
Data: 2026-06-12T09:35:56.824774+00:00
Modo: preview

## Evidência
- Menus: `main-menu, mega-menu-c-pia-1, mega-menu-mobile`
- Coleções alvo: `141`
- Produtos escaneados: `2334`
- Produtos com mudança planejada: `0`
- NEW 90d encontrados: `189`
...
## Rollback
- Snapshot: `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/reports/catalog-badges-sync/badge-sync-20260612T093556Z/rollback-snapshot.json`
