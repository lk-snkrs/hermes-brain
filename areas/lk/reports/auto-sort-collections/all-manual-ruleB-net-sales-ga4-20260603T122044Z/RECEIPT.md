...
Data: 2026-06-03T12:34:16.037374+00:00
...
## Coleções
- Todos os Produtos (`ultimos-lancamentos-2`): moves=1802; admin_full_ok=True; public_top12_ok=True
...
- Tênis e Sneakers Originais (`sneakers`): moves=1082; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis New Balance 204L Mushroom Arid Stone Marrom — slots_1_2_best_seller
  - 2. Tênis New Balance 204L Arid Timberwolf Bege — slots_1_2_best_seller
...
- Apparels (`roupas`): moves=375; admin_full_ok=True; public_top12_ok=True
  ...
  - 3. Moletom Aimé Leon Dore Overlay Logo Crewneck Sweatshirt Verde — slots_3_4_new_90d
  - 4. Boné Aimé Leon Dore Micro Logo Hat Bege/Verde — slots_3_4_new_90d
- Nike (`nike-todos-os-modelos`): moves=481; admin_full_ok=True; public_top12_ok=True
  ...
  - 3. Tênis Nike Air Jordan 1 Retro Low OG Howard University Vermelho — slots_3_4_new_90d
  - 4. Tênis Nike Air Jordan 1 Retro Low OG SP Travis Scott Shy Pink Bege — slots_3_4_new_90d
- Camiseta (`camiseta-1`): moves=141; admin_full_ok=True; public_top12_ok=True
...
- Adidas (`adidas-todos-os-modelos`): moves=163; admin_full_ok=True; public_top12_ok=True
...
- Air Jordan (`air-jordan`): moves=115; admin_full_ok=True; public_top12_ok=True
...
- Air Jordan 1 (`air-jordan-1`): moves=110; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Nike Air Jordan 1 Low OG Obsidian UNC Azul — slots_1_2_best_seller
  - 2. Tênis Nike Air Jordan 1 Low Og Sp x Travis Scott Medium Olive Verde — slots_1_2_best_seller
  - 3. Tênis Nike Air Jordan 1 Retro Low OG Howard University Vermelho — slots_3_4_new_90d
  - 4. Tênis Nike Air Jordan 1 Retro Low OG SP Travis Scott Shy Pink Bege — slots_3_4_new_90d
- Nike Dunk (`nike-dunk`): moves=138; admin_full_ok=True; public_top12_ok=True
  ...
  - 4. Tênis Nike Dunk Low SE Animal Colorido — slots_5_6_best_seller
- Onitsuka Tiger (`onitsuka-tiger-todos-os-modelos`): moves=67; admin_full_ok=True; public_top12_ok=True
...
- Athleisure (`athleisure`): moves=63; admin_full_ok=True; public_top12_ok=True
  - 1. Jaqueta Lululemon Define Nulu — slots_1_2_best_seller
  - 2. Calça Alo Yoga Suit Up Trouser (Regular) Preto — slots_1_2_best_seller
...
- Acessórios (`acessorios`): moves=21; admin_full_ok=True; public_top12_ok=True
...
- New Balance (`new-balance-todos-os-modelos`): moves=25; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis New Balance 204L Mushroom Arid Stone Marrom — slots_1_2_best_seller
  - 2. Tênis New Balance 204L Arid Timberwolf Bege — slots_1_2_best_seller
...
- Alo Yoga (`alo-yoga-1`): moves=20; admin_full_ok=True; public_top12_ok=True
...
- Moletom (`moletom-1`): moves=52; admin_full_ok=True; public_top12_ok=True
...
- Onitsuka Tiger Mexico 66 (`onitsuka-tiger-mexico-66`): moves=29; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Onitsuka Tiger Mexico 66 Kill Bill Amarelo — slots_1_2_best_seller
  - 2. Tênis Onitsuka Tiger Mexico 66 Sabot Birch Peacoat Bege — slots_1_2_best_seller
  - 3. Tênis Onitsuka Tiger Mexico 66 Fringe Yellow/Black Amarelo — slots_3_4_new_90d
  - 4. Tênis Onitsuka Tiger Mexico 66 Fringe Mocha Brown/Dark Brown Marrom — slots_3_4_new_90d
- Adidas Samba (`samba`): moves=38; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Adidas Samba OG Crochet Pack Sand Strata Bege — slots_1_2_best_seller
...
- Adidas Samba (`adidas-samba`): moves=38; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Adidas Samba OG Crochet Pack Sand Strata Bege — slots_1_2_best_seller
  - 2. Tênis Adidas Samba OG Earth Strata Wonder White Marrom — slots_1_2_best_seller
  - 3. Tênis Adidas Samba Jane Chalk White Wonder Quartz Branco — slots_3_4_new_90d
  - 4. Tênis Adidas Samba OG Crochet Pack Orbit Green Verde — slots_5_6_best_seller
- Boné | Apparels (`bone-streetwear`): moves=9; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis New Balance 9060 Boné Sparrow Marrom — slots_1_2_best_seller
  - 2. Boné 5 Panel Aimé Leon Dore Unisphere Branco — slots_1_2_best_seller
  - 3. Boné Aimé Leon Dore Micro Logo Hat Bege/Verde — slots_3_4_new_90d
  - 4. Boné Aimé Leon Dore Saint George Logo Hat Bege/Verde — slots_3_4_new_90d
- Saint Studio (`saint-studio`): moves=7; admin_full_ok=True; public_top12_ok=True
  - 1. Camiseta Saint Studio Classy Suedine Supima Chairs Branco — slots_1_2_best_seller
...
- Calça | Apparels (`calca-streetwear`): moves=15; admin_full_ok=True; public_top12_ok=True
  - 1. Calça Alo Yoga Suit Up Trouser (Regular) Preto — slots_1_2_best_seller
...
- Nike Dunk SB (`nike-dunk-sb`): moves=12; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Nike SB Dunk Low Pro St. Patrick's Day Verde — slots_1_2_best_seller
  - 2. Nike Dunk SB Dunk Low QS BHM Rodeo Verde — slots_1_2_best_seller
...
- Collectibles (`collectibles`): moves=4; admin_full_ok=True; public_top12_ok=True
...
- New Balance 9060 (`new-balance-9060`): moves=9; admin_full_ok=True; public_top12_ok=True
...
- Lululemon (`lululemon`): moves=10; admin_full_ok=True; public_top12_ok=True
  - 1. Jaqueta Lululemon Define Nulu — slots_1_2_best_seller
...
- Aphase (`aphase`): moves=2; admin_full_ok=True; public_top12_ok=True
...
- Adidas Gazelle (`adidas-gazelle`): moves=12; admin_full_ok=True; public_top12_ok=True
...
- Eyewear (`eyewear`): moves=15; admin_full_ok=True; public_top12_ok=True
...
- Jaqueta | Apparels (`jaqueta-streetwear`): moves=2; admin_full_ok=True; public_top12_ok=True
  - 1. Jaqueta Lululemon Define Nulu — slots_1_2_best_seller
  - 2. Jaqueta Lululemon Define Cropped Nulu Light Ivory/Gold/Gold Off White — slots_1_2_best_seller
  - 3. Jaqueta Lululemon Define Nulu Black Plum/Gold Roxo — slots_3_4_new_90d
  - 4. Jaqueta Lululemon Define Nulu Black/Gold Preto — slots_3_4_new_90d
- Nike Air Force 1 (`nike-air-force-1`): moves=6; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Nike Air Force 1 Low x Supreme Wheat Marrom — slots_1_2_best_seller
...
- Skims (`skims`): moves=5; admin_full_ok=True; public_top12_ok=True
...
- Dane-se (`dane-se`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Nike Air Max (`nike-air-max`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Short | Apparels (`short-streetwear`): moves=0; admin_full_ok=True; public_top12_ok=True
  ...
  - 3. Shorts Saint Studio Plissado Tech Preto — slots_3_4_new_90d
  - 4. Shorts Saint Studio Everywear Preto — slots_3_4_new_90d
- Adidas Gazelle Indoor (`adidas-gazelle-indoor`): moves=10; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Adidas Gazelle Indoor Maroon Almost Yellow Marrom — slots_1_2_best_seller
  - 2. Tênis Adidas Gazelle Indoor Liberty London Floral Embroidery Stripes Multi-Color — slots_1_2_best_seller
  - 3. Tênis Adidas Gazelle Indoor Liberty London Floral Embroidery Multi-Color — slots_5_6_best_seller
  - 4. Tênis Adidas Gazelle Indoor Bad Bunny Cabo Rojo Rosa — slots_5_6_best_seller
- Kids (`kids-1`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Represent Clo. (`represent-clo`): moves=1; admin_full_ok=True; public_top12_ok=True
  ...
  - 3. Moletom Represent Clo Storms in Heaven Black Preto — slots_5_6_best_seller
  - 4. Moletom Represent Clo Owners Club Zip Ash Grey Cinza — slots_5_6_best_seller
...
- BE@RBRICK (`be-rbrick`): moves=3; admin_full_ok=True; public_top12_ok=True
...
- Asics (`asics-todos-os-modelos`): moves=12; admin_full_ok=True; public_top12_ok=True
...
- Camisa | Apparels (`camisa-streetwear`): moves=8; admin_full_ok=True; public_top12_ok=True
  - 1. Camisa Aphase Check - Light Blue Azul — zona4_oos_or_unavailable_tail
  - 2. Camisa Pace EOT Cuban Collar Off White — zona4_oos_or_unavailable_tail
...
- Comme des Garçons (`comme-des-garcons`): moves=2; admin_full_ok=True; public_top12_ok=True
...
- Adidas Samba Jane (`adidas-samba-jane`): moves=3; admin_full_ok=True; public_top12_ok=True
...
- Onitsuka Tiger Mexico Mid (`onitsuka-tiger-mexico-mid`): moves=4; admin_full_ok=True; public_top12_ok=True
...
- Adidas x Clot (`adidas-x-clot`): moves=3; admin_full_ok=True; public_top12_ok=True
...
- Palm Angels (`palm-angels`): moves=1; admin_full_ok=True; public_top12_ok=True
  ...
  - 4. Óculos de Sol Palm Angels PERI037-0107 Branco — zona4_oos_or_unavailable_tail
...
- Ami Paris (`ami-paris`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Onitsuka Tiger Mexico 66 Exposed (`onitsuka-tiger-mexico-66-exposed`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Vans (`vans-todos-os-modelos`): moves=1; admin_full_ok=True; public_top12_ok=True
...
- Vans Skool (`vans-skool`): moves=1; admin_full_ok=True; public_top12_ok=True
  - 1. Tênis Vans "Knu Old Skool Black White" Preto — zona4_oos_or_unavailable_tail
  - 2. Tênis Vans Old Skool Lx  x Bape Abc Camo Pink Blue Green Preto — zona4_oos_or_unavailable_tail
  - 3. Tênis Vans Knu Skool MTE-1 LX Imran Potato Azul — zona4_oos_or_unavailable_tail
  - 4. Tênis Vans Knu Skool MTE x Imra Potato Black Preto — zona4_oos_or_unavailable_tail
...
## Rollback
- Snapshot: `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/reports/auto-sort-collections/all-manual-ruleB-net-sales-ga4-20260603T122044Z/rollback-snapshot-pre-write.json`
- Receipt JSON: `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/reports/auto-sort-collections/all-manual-ruleB-net-sales-ga4-20260603T122044Z/receipt-final.json`
