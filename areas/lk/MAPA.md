...
- `projetos/lk-mordomo-os-prd-2026-06-05.md` — PRD v0.1 do LK Mordomo OS: camada action-first/Decision Inbox da LK para roteamento de sinais, aprovações, follow-ups, CRM/recompra, Stock/Sourcing Assistant, Campaign/Growth Gate e Learning Loop, mantendo Telegram de Lucas para decisão/exceção/falha.
