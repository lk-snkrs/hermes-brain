...
- timestamp UTC: `2026-06-05T18:45:19.412620+00:00`
...
- active render DEV/Production: `True` / `False`

## Scope proposed
- merge mode: `append-new-marker`
- production before SHA12: `089cc730d730`
- proposed after SHA12: `7cd4319ca786`
- existing Production markers preserved/order: `True`
- marker count before/after: `18` / `19`
