# Redirect — LKGOC-QA-SCREENSHOT-STANDARD.md

Status: **migrado fisicamente em 20260627T165951Z**.

O canônico LKGOC agora fica no diretório dono `collection-optimizer`:

`/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/collection-optimizer/LKGOC-QA-SCREENSHOT-STANDARD.md`
