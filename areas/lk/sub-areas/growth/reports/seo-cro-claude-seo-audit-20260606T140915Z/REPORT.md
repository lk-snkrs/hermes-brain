...
Texto público visível na página:
...
- Homepage: networkidle não estabilizou em 45s; 234 resources; 86 scripts; 103 `other`; 30 imagens; load ~3,36s, DOMContentLoaded ~1,99s.
- Adidas Samba Jane: networkidle não estabilizou em 45s; 233 resources; 87 scripts; load ~4,44s.
