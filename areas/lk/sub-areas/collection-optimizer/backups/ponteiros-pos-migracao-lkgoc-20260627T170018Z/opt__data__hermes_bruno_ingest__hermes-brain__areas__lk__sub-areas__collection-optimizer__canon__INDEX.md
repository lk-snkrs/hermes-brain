...
O fato de alguns documentos históricos ainda estarem fisicamente em `areas/lk/sub-areas/growth/` é **legado de path**, não hierarquia Growth → LKGOC. Quando houver conflito:

1. Esta camada `collection-optimizer` define ownership, handoffs e guardrails de execução LKGOC.
2. A suite `growth/LKGOC-*` continua sendo fonte canônica de conteúdo/contrato até migração física completa.
...
4. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-PADRAO-CANONICO.md`
5. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-PRD.md`
6. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-INPUT-CONTRACT.md`
7. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-EVIDENCE-PACKET.md`
8. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-EXECUTION-WORKFLOW.md`
9. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-SCORECARD-100.md`
10. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-MAPA-JA-FEITO.md`
11. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-LEDGER-COLECOES-OTIMIZADAS.md`
12. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-QA-SCREENSHOT-STANDARD.md`
13. `/opt/data/hermes_bruno_ingest/hermes-brain/areas/lk/sub-areas/growth/LKGOC-THEME-TARGET-CONTEXT.md`
14. Playbook aplicável em `collection-optimizer/playbooks/`
15. Workdir/receipt/approval packet da coleção alvo

## Artefatos canônicos históricos ainda em `growth/`
