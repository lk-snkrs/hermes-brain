...
## P0/P1 — Alo Yoga
- Handle alvo: `/collections/alo-yoga-1`
...
- Status atual: handle validado como `/collections/alo-yoga-1`; sortimento amplo validado read-only
- Evidências comerciais:
...
- Candidato llms.txt: `Alo Yoga na LK Sneakers: /collections/alo-yoga-1 — curadoria premium de activewear e lifestyle, com peças Accolade, calças, tênis e itens para looks urbanos confortáveis.`
- FAQ canônico:
  - O que é Alo Yoga?
