# LK Stock OS — variant promotion after full live match

- Run ID: `20260611T023437Z`
- Input DB: `areas/lk/sub-areas/stock/data/lk_stock_os_current_full_live_match_tiny_stock_20260611T012728Z.db`
- Output DB: `areas/lk/sub-areas/stock/data/lk_stock_os_current_variant_promotion_20260611T023437Z.db`
- Promoted exact variant rows: `4288`
- Current local rows after promotion: `5191`
