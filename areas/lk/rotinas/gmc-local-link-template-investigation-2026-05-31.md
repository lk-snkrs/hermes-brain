# LK GMC — Packet E local link_template investigation — 2026-05-31

Gerado em: `2026-05-31T17:48:06.520874+00:00`
...
- Afetados nesta leitura: `10436` produtos/ofertas.
- Canais afetados: `{'local': 10436}`.
- Source dos produtos afetados: `{'api': 10436}`.
- Prefixo offerId: `{'LIA_': 10436}`.
- `link_template`/`mobile_link_template` no product resource: `{'missing': 10436}`.
- Sinal de `store_code` no template atual: `{'no_store_code_signal': 10436}`.

## Evidência do issue

- `10436`× — A valid [link_template] value with store code is required for the offer to serve

- Destinos do issue: `{'Shopping': 10436}`.
- Atributo citado pelo Merchant: `{'link template': 10436}`.
...
CSV preview dos primeiros 200 afetados: `reports/lk-gmc-local-link-template-preview-2026-05-31.csv`.
