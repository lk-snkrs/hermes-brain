# LK OS, Weekly Stock/SKU Action Plan read-only, 2026-05-11

Generated at: `2026-05-11T19:22:20.549110+00:00`
...
- P0: 6
- P1: 8
- Sinal de receita Shopify nas linhas: R$ 89.669,71
...
- SKU: `U9060CCC-4`
- Venda Shopify: 3 un, R$ 8.399,97
- Tiny `LK | CONTROLE ESTOQUE`: `0.0`
- Risco: `ruptura` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: cotação/sourcing interno prioritário; validar fornecedor, lead time e margem antes de qualquer compra

### 2. Tênis Nike Moon Shoe SP Jacquemus Medium Brown Marrom | 38
- Prioridade: P0 | ruptura com venda repetida
- SKU: `HV8547-200-38`
- Venda Shopify: 2 un, R$ 11.999,98
- Tiny `LK | CONTROLE ESTOQUE`: `0.0`
- Risco: `ruptura` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: cotação/sourcing interno prioritário; validar fornecedor, lead time e margem antes de qualquer compra
...
- Prioridade: P0 | ruptura com venda repetida
- SKU: `HV8547-002-36`
- Venda Shopify: 2 un, R$ 10.999,98
- Tiny `LK | CONTROLE ESTOQUE`: `0.0`
- Risco: `ruptura` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: cotação/sourcing interno prioritário; validar fornecedor, lead time e margem antes de qualquer compra
...
- Prioridade: P0 | ruptura com venda repetida
- SKU: `U9060WHT-4`
- Venda Shopify: 2 un, R$ 5.199,98
- Tiny `LK | CONTROLE ESTOQUE`: `-1.0`
- Risco: `ruptura` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: cotação/sourcing interno prioritário; validar fornecedor, lead time e margem antes de qualquer compra
...
- SKU: `HV8547-001-1`
- Venda Shopify: 1 un, R$ 6.999,99
- Tiny `LK | CONTROLE ESTOQUE`: `0.0`
- Risco: `ruptura` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: validar estoque Tiny atual e lead time; cotar se fizer sentido comercial
...
- Prioridade: P1 | baixo estoque contra venda da semana
- SKU: `MR530EMA-5`
- Venda Shopify: 3 un, R$ 5.999,97
- Tiny `LK | CONTROLE ESTOQUE`: `1.0`
- Risco: `baixo_estoque_vs_venda_da_semana` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: checar cobertura, reserva e reposição preventiva; sem compra sem aprovação

### 10. Tênis Nike Moon Shoe SP Jacquemus Pale Pink Rosa | 37
- Prioridade: P1 | baixo estoque contra venda da semana
- SKU: `HV8547-601-37`
- Venda Shopify: 2 un, R$ 11.999,98
- Tiny `LK | CONTROLE ESTOQUE`: `2.0`
- Risco: `baixo_estoque_vs_venda_da_semana` | match: `exact_norm_sku` | confiança: `high`
- Próxima ação preview: checar cobertura, reserva e reposição preventiva; sem compra sem aprovação
...
- Prioridade: P1 | estoque desconhecido ou SKU sem match seguro
- SKU: `MED-3410398-OS`
- Venda Shopify: 3 un, R$ 449,97
- Tiny `LK | CONTROLE ESTOQUE`: `n/d`
- Risco: `unknown` | match: `no_safe_candidate` | confiança: `needs_sku_or_stock_validation`
- Próxima ação preview: resolver SKU/Tiny antes de sourcing; não comprar nem anunciar como disponível
