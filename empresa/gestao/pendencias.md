...
- [ ] **Preencher dicionário canônico de influencers/campanhas LK e auditar match influencer → produto** — LK/Analytics/Tráfego Pago — estrutura documental criada em `areas/lk/sub-areas/trafego-pago/rotinas/campaign-attribution-dictionary.md` e template em `areas/lk/sub-areas/trafego-pago/templates/campaign-attribution-record.md`. Próxima ação: preencher Lala Noleto, Silvia Heinz, Helena Lunardelli e campanhas broad/Advantage+/RMKT com variações de nome, handles, cupons, UTMs, campaign/adset/ad patterns, títulos reais de campanha, janelas reais e produtos vendidos; depois calcular ROAS operacional apenas com Shopify evidence + custo relacionado. Evidência/base: `reports/lk-meta-campaign-title-roas-readonly-2026-05-10.md`, `reports/lk-roas-influencer-correction-readonly-2026-05-10.md`, `reports/lk-paid-attribution-brief-real-2026-05-08-v03.md` e `reports/lk-stock-influencer-audit-readonly-2026-05-10.md`.
