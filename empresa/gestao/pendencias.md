...
- [ ] **Gerar primeiro Stock Intelligence real/read-only da LK com sourcing acionado por sinal** — LK/Stock/Sourcing — próxima ação: usar Shopify vendas + Tiny `LK | CONTROLE ESTOQUE` para listar produtos/modelos/tamanhos com ruptura provável, cobertura menor que lead time e candidatos a checagem Droper/Monbam/fontes Brasil/fora. Sem WhatsApp, Notion, compra ou alteração produtiva sem aprovação.
