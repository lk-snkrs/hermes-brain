...
- [ ] **Aprofundar dicionário canônico de influencers/campanhas LK e auditar match influencer → produto** — LK/Analytics/Tráfego Pago — rotina/template criados e seed v0.1 preenchido em `areas/lk/sub-areas/trafego-pago/contexto/campaign-attribution-dictionary-seed-v0.md`. Próxima ação: confirmar handles/cupons/UTMs oficiais, separar campanhas broad/Advantage+/RMKT por anúncio/influencer, preencher janelas reais e calcular ROAS operacional apenas com Shopify evidence + custo relacionado. Prioridade: Lala Noleto, porque há spend/plataforma forte e zero evidência Shopify direta encontrada no recorte. Evidência/base: `reports/lk-meta-campaign-title-roas-readonly-2026-05-10.md`, `reports/lk-roas-influencer-correction-readonly-2026-05-10.md`, `reports/lk-paid-attribution-brief-real-2026-05-08-v03.md` e `reports/lk-stock-influencer-audit-readonly-2026-05-10.md`.
