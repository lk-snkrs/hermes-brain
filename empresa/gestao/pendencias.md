...
- [ ] **Criar mapa canônico SKU Shopify ↔ Tiny** — LK/Stock/Data Quality — próxima ação: listar campeões `mapear SKU no Tiny`, propor `SKU Shopify → produto/alias Tiny`, marcar confiança e preparar preview de correção no Tiny; não alterar SKU Shopify nem fazer write no Tiny sem aprovação.
