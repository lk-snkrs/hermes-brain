...
- [x] **Gerar primeiro Stock Intelligence real/read-only da LK com sourcing acionado por sinal** — LK/Stock/Sourcing — concluído em 2026-05-10 com `reports/lk-stock-influencer-audit-readonly-2026-05-10.md`. Próxima ação: corrigir vínculo SKU Shopify ↔ Tiny nos campeões sem saldo encontrado e criar dicionário canônico de influencers/cupom/UTM antes de qualquer alerta para compra.
