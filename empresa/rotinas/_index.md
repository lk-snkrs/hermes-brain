...
| LK Mission Control Snapshot 2026-05-12 | `areas/lk/rotinas/mission-control-snapshot-2026-05-12.md` | Fase 9 Mission Control v1: visão executiva read-only com 4 crons, 3 reports obrigatórios, 24 ledger records, 5 aprovações, 3 bloqueios de dados, Klaviyo Draft, sourcing readiness e GMC queue |
