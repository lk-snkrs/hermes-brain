# Runtime Truth Reconciler — 2026-06-03

Timestamp UTC: 2026-06-03T11:20:00Z
Timestamp BRT: 2026-06-03T08:20:00-0300
...
## Inventário completo — 2026-06-03

| id | Nome | Schedule | Deliver | Estado | Último status |
|----|------|----------|---------|--------|---------------|
| f5a23dd6a1bd | Lucas Brain daily intelligence loop | 0 5 * * * | local | active | ok (2026-06-03T05:06) |
| edd06fe19397 | Hermes runtime + cron watchdog no_agent | */30 * * * * | local | active | ok (2026-06-03T11:00) |
| 7c688553e293 | LK Daily Sales Brief read-only mandatory delivery | 0 11 * * * | local | active | ok (2026-06-03T11:01) |
| 953b9055458e | LK Weekly CEO Review read-only mandatory delivery | 0 12 * * 1 | local | active | ok (2026-06-01T12:01) |
| 71b147362ec1 | Zipper Gmail style learning refresh | 20 6 * * * | local | active | ok (2026-06-03T06:22) |
| 4bb4e2223fd3 | Hermes compression failure self-heal watchdog | */10 * * * * | local | active | ok (2026-06-03T11:10) |
| c3bb587519d2 | LK Pulso Comercial 16h read-only delivery | 0 19 * * * | local | active | **error: wacli hermes not authenticated** (2026-06-02T19:00) |
| e3279babbc4a | LK 09h previous-day sales report external delivery | 0 12 * * * | local | active | **error: wacli hermes not authenticated** (2026-06-02T12:00) |
| a2ead305eab2 | LK 19h30 physical store close external delivery | 30 22 * * * | local | active | **error: wacli hermes not authenticated** (2026-06-02T22:30) |
| ac0b440e2643 | Mordomo Telegram gateway watchdog | every 1m | local | **paused** | ok (2026-05-30T15:52) |
| 357d40a5863e | Zipper OS vendas 09h WhatsApp/email | 0 12 * * 1-5 | local | active | **error: wacli account hermes not authenticated** (2026-06-02T12:00) |
| 876d54c62ccd | LK Growth Telegram gateway watchdog | every 1m | local | **paused** | ok (2026-05-30T15:52) |
| 749ee30b51eb | Mesa COO diária Telegram | 0 9 * * * | **origin** | active | ok (2026-06-03T09:01) |
| 663e3e6a148c | SPITI Telegram gateway watchdog | every 1m | local | **paused** | ok (2026-05-30T15:52) |
| 3fc45b0830c6 | Hermes Brain Fechamento Ágil 01h + Brain Sync | 0 4 * * * | local | active | ok (2026-06-03T04:11) |
| f4c499e85eac | Lucas Brain weekly Learning Loop report | 15 12 * * 1 | local | active | ok (2026-06-01T12:18) |
| d03fa04e1188 | Hermes Brain Operating Layer structural watchdog | 10 11 * * * | local | active | ok (2026-06-03T11:10) |
| 2404c0766d33 | Hermes Brain Runtime Truth Reconciler | 20 11 * * * | local | active | ok (2026-06-02T11:24) |
| 98478b820720 | Relatório Hermes diário 01h + 02h + 02h15 para Lucas | 30 5 * * * | **origin** | active | ok (2026-06-03T05:33) |
| d9badcd83411 | Hermes Brain strict-runtime guard watchdog | 0 10 * * * | local | active | ok (2026-06-03T10:00) |
| c1ce34b4449a | Hermes multi-profile latency watchdog | every 15m | **origin** | active | ok (2026-06-03T11:18) |
...
| 5bacaa61bb12 | claude-proxy-watchdog | every 5m | local | active | ok (2026-06-03T11:18) |
| 3cd1011edf33 | claude-max-proxy watchdog | every 5m | local | active | ok (2026-06-03T11:18) |
| 955dc769b5a6 | LK specialist Telegram gateway watchdog | every 1m | **origin** | **paused** | ok (2026-05-30T15:52) |
| b78ae7ac81d0 | Hermes all Telegram gateways watchdog | every 1m | **origin** | active | ok (2026-06-03T11:19) |
| c64a0c63b881 | LK Tiny stock local DB daily fullsync | 20 10 * * * | local | active | ok (2026-06-03T10:45) |
| f9a1d43caf48 | Hermes memory hygiene watchdog 02h15 BRT | 15 5 * * * | local | active | ok (2026-06-03T05:15) |
...
- Brain health check: `python3 scripts/brain_health_check.py --json reports/brain-health-check-2026-06-03-runtime-truth-reconciler.json` — **All checks passed** (`FAIL=0`, `WARN=0`).
