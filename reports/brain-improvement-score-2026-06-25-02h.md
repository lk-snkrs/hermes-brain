# Brain Improvement Score — 2026-06-25
## Status geral
Score geral: **100/100**
...
Evidências:
- Rotinas documentadas: 389
- Cobertura aproximada no índice por nome de arquivo: 380/389
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-06-25-02h.json
- FAIL=0 WARN=0
- Disponível: True
- JSON parse_ok: True
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-06-25-02h.json`; disponível=True; FAIL=0; WARN=0.
