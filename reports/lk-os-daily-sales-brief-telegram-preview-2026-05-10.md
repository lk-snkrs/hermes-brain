...
• Tiny: ruptura `4`, baixo estoque `3`, unknown `3`. Fonte: `fact_tiny_stock`.

**Alertas acionáveis**
• [P0] Preparar preview de reposição/sourcing para SKUs vendidos com saldo zero no Tiny. Motivo: 4 SKU(s) vendidos aparecem em ruptura no depósito oficial. Fonte: `derived_reconciliation`.
...
• [P1] Resolver mapeamento Shopify SKU ↔ Tiny antes de campanha ou reposição automática. Motivo: 3 SKU(s) vendido(s) sem candidato Tiny seguro ou sem saldo legível. Fonte: `derived_reconciliation`.
