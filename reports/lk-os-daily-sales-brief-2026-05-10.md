...
Gerado em: `2026-05-11T19:01:21.825107+00:00`.
Janela: `2026-05-10T00:00:00-03:00` a `2026-05-10T23:59:59-03:00`.
Arquivo privado auditável, fora do Git: `/opt/data/hermes_bruno_ingest/local_sql/lk_data_spine_snapshots/lk_os_daily_sales_brief_20260510_190121Z.json`.
...
Tiny: **{'ruptura': 4, 'unknown': 3, 'baixo_estoque_vs_venda_do_dia': 3}** nos SKUs vendidos checados. Fonte: `fact_tiny_stock`.
...
- **Tênis Nike Moon Shoe SP Jacquemus Off Noir Preto**, SKU `HV8547-001-7`, tamanho `40`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `no_safe_candidate`.
- **Tênis Nike Moon Shoe SP Jacquemus Pale Pink Rosa**, SKU `HV8547-601-37`, tamanho `37`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `no_safe_candidate`.
...
- [P1] Revisar cobertura dos SKUs com saldo menor ou igual à venda do dia. Motivo: 3 SKU(s) com venda do dia encostando no saldo oficial. Aprovação: Sim, se virar compra, preço ou contato.. Fonte: `derived_reconciliation`.
