...
Gerado em: `2026-05-11T18:53:12.217156+00:00`.
Janela: `2026-05-10T00:00:00-03:00` a `2026-05-10T23:59:59-03:00`.
Arquivo privado auditável, fora do Git: `/opt/data/hermes_bruno_ingest/local_sql/lk_data_spine_snapshots/lk_os_daily_sales_brief_20260510_185312Z.json`.
...
Tiny: **{'ruptura': 4, 'unknown': 5, 'baixo_estoque_vs_venda_do_dia': 1}** nos SKUs vendidos checados. Fonte: `fact_tiny_stock`.
...
- **Tênis Nike Moon Shoe SP Jacquemus Pale Pink Rosa**, SKU `HV8547-601-37`, tamanho `37`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `exact_norm_sku`.
- **Tênis Nike Vomero Premium Barely Volt Verde**, SKU `HQ2050-300-6`, tamanho `39`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `no_safe_candidate`.
- **Chinelo Slide Nike Mind 001 Light Smoke Grey Cinza**, SKU `HQ4307-003-10`, tamanho `43`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `no_safe_candidate`.
- **Tênis New Balance 9060 Triple White Branco**, SKU `U9060NRJ-38`, tamanho `38`: vendido 1 un.; saldo Tiny `n/d`; risco `unknown`; match `no_safe_candidate`.
...
- **Tênis Onitsuka Tiger Tsunahiki Slip-On White/Black Branco**, SKU `1183C529.101-8`, tamanho `41`: vendido 1 un.; saldo Tiny `0.0`; risco `ruptura`; match `exact_norm_sku`.
...
- **Tênis New Balance 9060 Cortado Marrom**, SKU `U9060496`, tamanho `37`: vendido 1 un.; saldo Tiny `1.0`; risco `baixo_estoque_vs_venda_do_dia`; match `exact_norm_sku`.
...
- [P1] Revisar cobertura dos SKUs com saldo menor ou igual à venda do dia. Motivo: 1 SKU(s) com venda do dia encostando no saldo oficial. Aprovação: Sim, se virar compra, preço ou contato.. Fonte: `derived_reconciliation`.
- [P1] Resolver mapeamento Shopify SKU ↔ Tiny antes de campanha ou reposição automática. Motivo: 5 SKU(s) vendido(s) sem candidato Tiny seguro ou sem saldo legível. Aprovação: Sim, se exigir correção de cadastro.. Fonte: `derived_reconciliation`.
