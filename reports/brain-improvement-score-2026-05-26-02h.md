...
Evidências:
- Rotinas documentadas: 347
- Cobertura aproximada no índice por nome de arquivo: 338/347
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-05-26-02h.json
- FAIL=0 WARN=0
- Disponível: True
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-05-26-02h.json`; disponível=True; FAIL=0; WARN=0.
