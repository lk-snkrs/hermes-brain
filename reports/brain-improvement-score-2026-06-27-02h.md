# Brain Improvement Score — 2026-06-27
## Status geral
Score geral: **94/100**
...
Evidências:
- Rotinas documentadas: 398
- Cobertura aproximada no índice por nome de arquivo: 389/398
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-06-27-02h.json
- FAIL=0 WARN=0
- Disponível: True
...
### Evidência
- Health check usado: reports/brain-health-check-2026-06-27-02h.json — disponível=True FAIL=0 WARN=0.
### Próxima ação segura
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-06-27-02h.json`; disponível=True; FAIL=0; WARN=0.
