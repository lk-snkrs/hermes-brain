# Brain Improvement Score — 2026-06-13
## Status geral
Score geral: **94/100**
...
Evidências:
- Rotinas documentadas: 383
- Cobertura aproximada no índice por nome de arquivo: 374/383
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-06-13-02h.json
- FAIL=0 WARN=0
- Disponível: True
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-06-13-02h.json`; disponível=True; FAIL=0; WARN=0.
