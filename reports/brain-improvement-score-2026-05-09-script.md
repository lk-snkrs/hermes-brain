...
- Diretórios com MAPA.md: 15
### Rotinas e crons — 100/100
Motivo: Rotinas documentadas estão indexadas; o score não afirma execução real de cron.
Evidências:
- Rotinas documentadas: 48
- Cobertura aproximada no índice por nome de arquivo: 48/48
Recomendações:
...
Evidências:
- Markdowns em skills/: 5
- Cobertura aproximada no índice: 5/5
Recomendações:
...
### Roadmap, changelog e pendências — 88/100
Motivo: Avalia rastreabilidade executiva e fila compacta de pendências.
Evidências:
- Arquivos de tracking ausentes: 0
- Checkboxes abertos nas pendências: 18
- Checkboxes concluídos nas pendências: 8
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-05-09-score-script.json
- FAIL=0 WARN=0
- Disponível: True
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-05-09-score-script.json`; disponível=True; FAIL=0; WARN=0.
