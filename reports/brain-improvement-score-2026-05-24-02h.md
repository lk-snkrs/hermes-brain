# Brain Improvement Score — 2026-05-25
## Status geral
Score geral: **94/100**
...
Evidências:
- Rotinas documentadas: 333
- Cobertura aproximada no índice por nome de arquivo: 325/333
Recomendações:
...
Evidências:
- Health check usado: reports/brain-health-check-2026-05-24-02h.json
- FAIL=0 WARN=0
- Disponível: True
...
## Evidências
- Health check JSON: `reports/brain-health-check-2026-05-24-02h.json`; disponível=True; FAIL=0; WARN=0.
